...
- "reliable" has two distinct senses — do not conflate them: (1) trustworthy/dependable (a vendor, a source) → "confiable"; (2) consistent/stable performance (a connection, a school's connectivity) → "estable" or "con conectividad estable". Never use "confiable" for the performance sense.
