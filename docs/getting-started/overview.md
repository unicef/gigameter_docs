...
Giga Meter was developed by Giga in 2023 in partnership with Ericsson.
...
> [!NOTE]
> **Disclaimer:** Giga Meter measures the internet speed received on the user's device, providing a direct assessment of the user's experience. The measurements pass through multiple ISP networks (between the school and measurement servers) and are therefore not designed to measure the unique service of the contracted Internet Service Provider (ISP). Factors beyond the ISP's service provision can influence the user device's connection. App measurements cannot be used on their own to contest ISP service provision.
